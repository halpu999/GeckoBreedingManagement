const CACHE_NAME = 'gecko-bm-v3.4.0';
const ASSETS_TO_CACHE = [
    ...
    './images/morphs/carrotHead.png',
    './images/morphs/baldy.png',
    './images/morphs/raptor.png',
    './images/morphs/aptor.png',
    './images/morphs/sunglow.png',
    './images/morphs/diabloBlanco.png',
    './images/morphs/blazingBlizzard.png',
    './images/morphs/ember.png',
    './images/morphs/nova.png',
    './images/morphs/dreamsickle.png',
    './images/morphs/radar.png',
    './images/morphs/whiteKnight.png',
    './images/morphs/aurora.png',
    './images/morphs/typhoon.png',
    './images/morphs/cyclone.png',
    './images/morphs/snowGlow.png',
    './images/morphs/mack_snow_raptor.png',
    './images/morphs/mack_snow_radar.png',
    './images/morphs/blackHole.png',
    './images/morphs/totalEclipse.png',
    './images/morphs/galaxy.png',
    './images/morphs/universe.png',
    './images/morphs/bananaBlizzard.png',
    './images/morphs/super_snow_albino.png',
    './images/morphs/ghostBlizzard.png',
    './images/morphs/phantomRaptor.png',
    './images/morphs/shadowRaptor.png',
    './images/morphs/cipherRaptor.png',
    './images/morphs/snow_blizzard.png',
    './images/morphs/snow_eclipse_blizzard.png',
    './images/morphs/darkKnight.png',
    './images/morphs/eclipse.png',
    './images/morphs/emerine.png',
    './images/morphs/enigma.png',
