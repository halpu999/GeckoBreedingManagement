...
const MORPH_DATABASE = {
  ...
  bae: {
    id: 'bae',
    name: 'BAE (Blue Amber Eye)',
    japaneseName: 'BAE',
    type: 'recessive',
    albinoGroup: null,
    description: '2018年にRon Tremperの妻によって発見された新しい劣性遺伝の目変異。瞳孔の周囲に青と琥珀色（アンバー）が入り、エクリプスと異なり透明感がある。',
    healthWarning: null,
    ethicalConcern: null,
    color: '#34495E',
    image: 'images/morphs/bae.png',
  },
  goldenEye: {
    id: 'goldenEye',
    name: 'Golden Eye',
    japaneseName: 'ゴールデンアイ',
    type: 'recessive',
    albinoGroup: null,
    description: '比較的新しい劣性遺伝の目変異。大きな金色の瞳と細かい金粉のような輝きを持つ。神経症状などの欠陥は見つかっていない。',
    healthWarning: null,
    ethicalConcern: null,
    color: '#D4AF37',
    image: 'images/morphs/goldenEye.png',
  },
  ghost: {
    id: 'ghost',
    name: 'Ghost',
...
const POLYGENIC_TRAITS = [
  ...
  { id: 'halloweenMask', name: 'Halloween Mask', japaneseName: 'ハロウィンマスク', description: 'Albey Scholl氏が作出。頭部に非常に太く黒い不気味なパターンが浮かび上がり、まさにハロウィンのマスクのような顔つきになるポリジェニック形質。', color: '#B8860B', image: 'images/morphs/halloweenMask.png' },
  { id: 'lavenderStripe', name: 'Lavender Stripe', japaneseName: 'ラベンダーストライプ', description: 'JMG Reptiles等が確立。明るいスミレ色（Lavender）の体色とストライプが組み合わさったライン。成長後も紫色が残るように選別交配されている。', color: '#DDA0DD', image: 'images/morphs/lavenderStripe.png' },
  { id: 'jungleGiant', name: 'Jungle Giant', japaneseName: 'ジャングルジャイアント', description: '不規則に乱れたジャングルパターンと、巨大化するジャイアント血統の融合。Ron Tremper系統等。', color: '#6B8E23', image: 'images/morphs/jungleGiant.png' },
  ...
  { id: 'lava', name: 'Lava', japaneseName: 'ラバ', description: 'Firewaterからさらに選別交配された（または派生した）、極めて強烈な赤・オレンジを放つハイエンドライン。HISS等の系統が有名。', color: '#B22222', image: 'images/morphs/lava.png' },
  { id: 'plasma', name: 'Plasma', japaneseName: 'プラズマ', description: 'Dolezel Reptilesが手掛けるプロジェクト。非常にユニークな色彩表現を持つ個体群の総称。', color: '#FF69B4', image: 'images/morphs/plasma.png' },
  { id: 'forgetMeNot', name: 'Forget Me Not', japaneseName: 'フォーゲットミーノット', description: 'Plasmaプロジェクトの中でも、特にラベンダー（紫）の発色が強いフェイズを指す。勿忘草のような淡く美しい青紫色。', color: '#9370DB', image: 'images/morphs/forgetMeNot.png' },
...
const COMBINATION_MORPHS = [
  ...
  {
    id: 'tangelo',
    image: 'images/morphs/tangelo.png',
    name: 'Tangelo',
    japaneseName: 'タンジェロ',
    description: 'Ron Tremper氏が作出。TangerineラインとTremper Albinoの交配による、極めて明るくエキゾチックなオレンジを放つトレンパーサングローの特化版。',
    components: ['tremperAlbino'],
    polygenicComponents: ['tangerine'],
  },
  {
    id: 'phantom',
    image: 'images/morphs/phantom.png',
    name: 'Phantom',
    japaneseName: 'ファントム',
    description: 'The Urban Gecko作出。Sunglow × TUG Snowの交配（TUG Snow + Tremper Albino + Super Hypo Tangerine）。淡くスモーキーなトーンと独特のシャドウベールを持つ。',
    components: ['tugSnow', 'tremperAlbino'],
    polygenicComponents: ['superHypo', 'tangerine'],
  },
  {
    id: 'goblin',
    image: 'images/morphs/goblin.png',
    name: 'Goblin',
    japaneseName: 'ゴブリン',
    description: 'The Urban Geckoが2014年に命名。TUG Snow + Tremper Albino + Eclipse等の多重コンボによる派生。全体的にオリーブグリーンやモスグリーンのような独特の暗緑色とダークなパターンを持つ。',
